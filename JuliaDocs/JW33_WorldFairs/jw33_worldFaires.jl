...
# ╔═╡ 664992f4-056b-4889-b5a0-bedf7b78e22c
begin
	using PlutoUI
	TableOfContents()
end

# ╔═╡ 1635a6fc-b55b-4177-9aeb-6fc725898b9f
using Tidier

# ╔═╡ 729c344b-f996-4fd5-a845-e883e0e01a20
using Chain

# ╔═╡ d161a12f-fbc5-4fc5-8d08-dbcf4f69699c
using PlotlyJS

# ╔═╡ 4cc4e52c-2d81-40c9-9a76-5aac8b1ea0d6
using CSVFiles

# ╔═╡ 1e73a2a0-c048-4343-99a3-0229b3e6a20c
using DataFrames

# ╔═╡ f0070464-4814-4472-9139-b888b0972da5
html"""
<center>
<div id="title">
	WORLD'S FAIRS
...
# ╔═╡ bcd38bc8-0588-4f74-835d-3a1995c0a645
html"""
<center>
<div 
	style = "
...
# ╔═╡ 3810e8cf-cbcf-4c28-975e-0249064a98e7
md"---"

# ╔═╡ 177a9af7-9473-4a30-a619-e2a34d900ab5
html"""
...
# ╔═╡ d7f83d24-6757-11ef-1163-c9fec22480aa
pwd()

# ╔═╡ d3ef73d8-024c-4bf8-bb98-df5bd7d3837e
html"""
...
# ╔═╡ 1d79ccf1-6648-409b-8261-aa8d6fb10e43
html"""
<h3 style = "color:skyblue">
	Data
"""

# ╔═╡ 221cbbad-bcc1-409c-a1dc-5bcf1a226231


# ╔═╡ 16006372-5b70-449e-ad38-1d27786eef2b
begin
	main = "https://raw.githubusercontent.com/rfordatascience/tidytuesday/master/"
	dat = "data/2024/2024-08-13/worlds_fairs.csv"
	dfr = load(main * dat) |> DataFrame
end;

# ╔═╡ 759fc74b-4f50-4df6-9189-bcd52a21e077
html"""
<h2 style = "color:dodgerblue">
	EDA
</h2>
...
# ╔═╡ 80fbf31d-ea7b-4f64-8047-d752f4d591f0
first(dfr, 3)

# ╔═╡ 12b7da05-09a2-44bc-a80a-6bddb1b376ba
describe(dfr)

# ╔═╡ a4e25bcb-da67-4b14-8d4c-26c40e50efed
dfc = dropmissing!(dfr);

# ╔═╡ c1d6d4c9-4273-4483-bc36-2e3b533087be
first(dfr, 3)

# ╔═╡ 1ecdbf03-237b-442b-b611-d909dd4ffe73
html"""
<h2 style = "color:dodgerblue">
	Data Analysis & Vis
</h2>
...
# ╔═╡ 20f81c83-b8c1-43ba-a125-22677d5ba1bd
plot(
    dfc,
    x=:start_year, y=:visitors
)
...
manifest_format = "2.0"
project_hash = "141e94cd70a9763a90122b545fe656d71b839b44"
