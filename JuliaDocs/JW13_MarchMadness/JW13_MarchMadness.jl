...
# ╔═╡ 506bd4c0-fbf9-4fef-8cd9-b97fef4a527d
begin
	using PlutoUI
	TableOfContents()
end

# ╔═╡ 91f634ed-db03-425b-bc3e-66c582cf92dd
using CSV, DataFrames, Pipe

# ╔═╡ 9da1d040-e54d-4351-966d-318f442650e4
using Chain, Tidier

# ╔═╡ ca13335d-311c-4e91-9509-48d609565d88
using Printf

# ╔═╡ 28b676b8-104c-4fde-98cc-82b975826f77
using PlutoPlotly

# ╔═╡ c5f2c4da-dfd6-41e8-b01e-cbfdc5204a40
html"""
...
# ╔═╡ ee747e16-633b-4af5-98ad-f95ba09bbab4
html"""
...
# ╔═╡ 0165f886-f309-11ee-0fb5-d53a5241ad82
pwd()

# ╔═╡ 888896a7-1afd-482d-824e-2dedf04fba81
md"---"

# ╔═╡ 687e1ea5-8562-4833-b75b-5ed843aa8df2
md"## Pacakges &  Data"

# ╔═╡ 39214975-1189-4266-8850-208f2c74636a
md"### Libraries"

# ╔═╡ 9712a877-99f5-42ef-bd2b-8fdc2a37d233
md"### Data"

# ╔═╡ a5640159-02bd-47d0-befe-225c2e2aa13d
begin
...
# ╔═╡ 1bd8b0d4-2c80-4a13-8d77-cd80ff9de010
df |> names

# ╔═╡ c13e760f-ff75-48c9-91a2-b90b485b7a99
Dict(names(df) .=> eltype.(eachcol(df))) |> DataFrame 

# ╔═╡ 1d2872f5-0b52-4bec-9e92-3498365dbc17
permutedims([1 2 3])

# ╔═╡ e4619e1e-f6d2-4e72-8799-3b829d2c7b78
first(df, 3)

# ╔═╡ d7e5b94d-5970-4be1-ab76-d1e607c70333
df |> describe

# ╔═╡ c5240157-f526-4cd4-a687-88822e26b1fc
md"## Data Wrangling + Viz"

# ╔═╡ 73695f4c-bead-45d9-94e1-a370a6757c55
md"### Percentage winning: top 20"

# ╔═╡ 31ffeaca-b14b-40f8-a13a-052b072fa650
...
# ╔═╡ 06bdf782-5033-4e2f-8637-bb7ef9987005
md"### TidierPlot"

# ╔═╡ 468c2efc-4ea9-4ba3-a94c-90a6322d787e
@chain wins_df begin
	ggplot(xticklabelrotation = .5)
	geom_col(aes(x = :name, y = :pct)) 
end

# ╔═╡ b96c9984-1e46-45c3-8764-36394da2e915
# using Plots

# ╔═╡ 6517a358-940a-4984-b8da-109bdaee18b8
#Plots.bar(wins_df.name, wins_df.pct, label = false)

# ╔═╡ 6d1acc26-aba2-4208-ac4e-b5333969555b
md"### PlutoPlotly"

# ╔═╡ 34809e50-41ae-405c-89d7-ad05206bc31d
wins_df2 = @chain wins_df @arrange(pct);

# ╔═╡ da2c56e0-6752-4a38-a8b0-500139e72529
PlutoPlotly.plot([5,6,7,2]; line_color="red")

# ╔═╡ c5593f17-018b-476a-8f88-3e3161b14a62
let 
	PlutoPlotly.plot(
