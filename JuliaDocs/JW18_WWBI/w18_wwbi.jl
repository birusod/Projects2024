...
# ╔═╡ 22100128-0fc7-11ef-1f13-d9bb323d72fb
begin 
	using PlutoUI
	TableOfContents()
end

# ╔═╡ d5661b99-721f-47d0-b0cd-9e875ef41b02
using Tidier

# ╔═╡ edcbaab0-d3b4-41f3-9a7c-4050531ec382
using Chain

# ╔═╡ b7cb88c6-fc26-4791-8d4a-f8b1f330c716
using ColorSchemes

# ╔═╡ 662c494d-2851-42cf-85c8-91e7931c6b63
using Colors, Formatting

# ╔═╡ 046da72d-46dc-4412-9c3c-907a2117b0e9
using CairoMakie

# ╔═╡ 0631ff11-8e82-44d4-820c-183bdbb24b42
html"""
...
<div style=" height: 150px; width: 200%; background: wheat; color: #88BBD6;
...
color: dodgerblue;
	">WORLDWIDE BUREAUCRATY INDICATORS
</p>

<p style="text-align: left; font-size: 1.8rem; color: seagreen">
	TidyTuesday Data: Week-18
</p>

<p style=" font-family: 'Boska'; font-size: 0.9rem; font-weight: 400; color: darkgreen;">
	&copy birusod
</p>
"""

# ╔═╡ cf8b0a33-627d-40d9-80a2-213745a76d31
md"---"

# ╔═╡ 21e27f07-ddd1-4af5-a038-504c4b56eebe
md"## Setup"

# ╔═╡ b42091c7-20f8-4d2b-91f9-2aabca3f09bc
html"""
...
# ╔═╡ 3271eaac-4fc6-481f-be2e-34581fe323c6
html"""
<h3 style="text-align:left;font-size: 1.4rem;color: gold;font-family:Fira;font-weight:200">
		Data
</h3>
...
# ╔═╡ 56cd6db4-ab15-4247-8f4d-1938092ae19f
readdir()

# ╔═╡ 318559c9-6e74-47f7-b0c8-52244e460b13
df = read_csv("edu_job.csv");

# ╔═╡ 6b7d698e-e3db-4af7-bbcb-0703f0356db8
md"## EDA + Data  wrangling"

# ╔═╡ e9bd09d2-95bd-4f59-a9a7-4747e505ab20
html"""
<h3 style="text-align:left;font-size: 1.4rem;color: gold;font-family:Fira;font-weight:200">
		Overview
</h3>
...
# ╔═╡ f537539b-63d5-4bcf-bf42-f9527058971b
first(df, 3)

# ╔═╡ 45f8d58f-d796-4988-b3e6-e56b0f696918
describe(df)

# ╔═╡ a4808ff1-34e2-4a70-9cdc-caa2991cd491
html"""
<h3 style="text-align:left;font-size: 1.4rem;color: gold;font-family:Fira;font-weight:200">
		Data prep for viz
</h3>
...
# ╔═╡ ae4afc72-e177-4343-b048-c68b2a56422d
md"
- Subset education level for: Tertiary Education
- Subset for group in: 
"

# ╔═╡ eed4cf2d-6226-4eef-9201-a49500f647a6
@pull(@count(df, group), group)

# ╔═╡ 7ef297fc-c4b1-4b4b-91ee-5163912f3d0f
@chain df begin
	@slice_head(n=3)
end

# ╔═╡ 3366f92a-3116-462c-992d-6d57208ccb91
dff = @chain df begin
	@filter(
		edu_level  == "Tertiary Education", 
		group ∈ ["Health", "Medical workers"],
		value > 0)
...
# ╔═╡ 61520df8-aca0-4493-a34e-cede1a5372ae
md"## Viz"

# ╔═╡ 23fbb032-aece-4a03-99c6-a62595fb4c1e
gg_theme1 = Theme(
	size = (700, 600),
	backgroundcolor = :black,
    Axis = (
		titlecolor = :white, titlesize = 30, #titlefont = :bold,
		subtitlecolor = "#bfbd38", subtitlesize = 18, #subtitlefont = :bold,
		titlefont = "Roboto", subtitlefont = "JuliaMono",
        ...
        xticksvisible = false,  
		xgridvisible = false, 
        xticklabelcolor = "#24aafe", 
	
		yticklabelcolor = "#24aafe",
		ytickcolor = "#24aafe",
		yticksvisible = true,
	 	ygridcolor = "grey20", 
    )
...
# ╔═╡ 1a8b1aca-4d73-4ac3-b232-34b8a3ae10d4
dff1 = @chain dff begin
	@arrange(desc(value))
end;

# ╔═╡ b44f31d8-0627-4425-8cd2-3fd9babb6729
@chain dff1 begin
	ggplot(xticklabelrotation = .5)
        geom_col(
			aes(y = :value, x = cat_inorder(:name)))
		theme_light() +
		labs(
			title = "BUREAUCRACY INDICATORS",
			subtitle = "Individuals with tertiary Education by country as\na share on average of public paid employees in\nSub-Saharan Africa in the Health Sector"
		) +
	gg_theme1
end

# ╔═╡ d9d16f8a-b01d-49da-8eaf-e9cc46a02fee
dff2 = @arrange(dff, value);

# ╔═╡ 930ef7b7-3e30-4331-8971-a25a7dad28ac
gg_theme2 = Theme(
	size = (700, 600),
	backgroundcolor = :black,
    Axis = (
		...
		yticklabelfont = "bold",
		ygridvisible = false, 
		yticklabelpad = -25, yticklabelalign = (:right, :center)
    )
)

# ╔═╡ 59aa3beb-52d0-44b3-ac5b-bb1f7b921ba3
@chain dff2 begin
	ggplot(yticks = (1:18, dff2.name))
        geom_col(
			aes(y = :value, x = cat_inorder(:name)),
			direction = "x"
			)
...
manifest_format = "2.0"
project_hash = "3d18c5675ae474b071dcf0437f165caae56fa09d"
...
git-tree-sha1 = "1a2603adcfe980264abfe30998d304be9601c469"
